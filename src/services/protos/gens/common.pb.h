...
PROTOBUF_NAMESPACE_OPEN
template<> ::vm_manager::EmptyMessage* Arena::CreateMaybeMessage<::vm_manager::EmptyMessage>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace vm_manager {
...
class EmptyMessage final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:vm_manager.EmptyMessage) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "vm_manager.EmptyMessage";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:vm_manager.EmptyMessage)
 private:
  class _Internal;
